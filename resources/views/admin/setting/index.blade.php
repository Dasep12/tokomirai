        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    ...
                    <!-- <button onclick="CrudSettings('create','*')" type="button" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Setting TokoMirai</h3>
                    </div>
...
@include('admin.setting.partials.crud')