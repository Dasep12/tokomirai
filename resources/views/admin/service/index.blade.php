        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    ...
                    <button onclick="CrudServices('create','*')" type="button" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <div id="productTable">
                            @include('admin.service.partials.table')
                        </div>
                    </div>
                </div>
            </div>
...
@include('admin.service.partials.crud')