 <!-- PROMO CARDS -->
 <div class="sec" style="background:var(--white2)">
     <div class="sec-inner">
         ...
         <div class="promo-grid">
             ...
             <div class="promo-card" onclick="setCatActive(null,'laptop');scrollToProducts()" style="">
                 ...
                 <div class="promo-card-body">
                     <div class="promo-card-label">Eksklusif Online</div>
                     <div class="promo-card-title">Laptop Intel Core Ultra<br>Generasi Terbaru</div>
                     <div class="promo-card-sub">Performa AI terbaik untuk pekerjaan kreatif</div>
             ...
             <div class="promo-card" onclick="setCatActive(null,'networking');scrollToProducts()" style="">
                 ...
                 <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:6rem;opacity:.25">📡</div>
                 <div class="promo-card-body">
                     <div class="promo-card-label">Hemat Hingga 30%</div>
                     <div class="promo-card-title">WiFi 6 Untuk Seluruh Rumah & Kantor</div>
                     <div class="promo-card-sub">Coverage luas, kecepatan tinggi, stabil</div>
             ...
             <div class="promo-card" onclick="scrollToServices()" style="">
                 ...
                 <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-size:6rem;opacity:.25">🔧</div>
                 <div class="promo-card-body">
                     <div class="promo-card-label">Layanan Profesional</div>
                     <div class="promo-card-title">Servis & Instalasi IT di Tempat Anda</div>
                     <div class="promo-card-sub">Teknisi berpengalaman, garansi pekerjaan</div>
                     <button class="btn-promo">Pesan Jasa <i class="ti ti-arrow-right" style="font-size:11px"></i></button>
                 </div>
             </div>
         </div>
     </div>
